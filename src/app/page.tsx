...
export default function Home() {
  ...
  const scheduleData = [
    ...
    { time: "12:30 PM", icon: "📣", event: "Software and Tech with Chris Boraski", location: "Gym" },
    { time: "1:00 PM", icon: "📖", event: "Open Mentorship with Chris Boraski", location: "Aux Gym" },
    { time: "1:30 PM", icon: "🍕", event: "Lunch", location: "Snack Shack" },
